...
def simulate(dt, T, x_init, x_target, plan_length, control_func, move_obstacles, path_rrt, waypoint_radius, num_states, num_inputs):
    ## Timesteps
    ...
    x_real[:, 0] = x_init
    last_plan = None
    target_state = [path_rrt.path_points[waypoint_idx][0], path_rrt.path_points[waypoint_idx][1], path_rrt.path_points[waypoint_idx][2]] + [0] * (num_states-3)
